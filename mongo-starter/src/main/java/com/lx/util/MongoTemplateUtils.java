 ...
 * @Author: jyu
 * @Date: 2021/10/28
 * @Description: this class is used to integration {@link MongoTemplate}
 **/
public class MongoTemplateUtils {

    private static MongoTemplate mt;

    private static MongoTemplate getMt() {
        if (mt == null) {
            mt = SpringContextUtils.getBean(MongoTemplate.class);
        }
        return mt;
    }
    ...
    public static Object findSortById(Class<?> entiy, String collName, Sort.Direction direction) {
        ...
        return getMt().find(query, entiy, collName);
    }
    ...
    public static Object findDesignField(List<String> fields, Map<String, Object> map, Class<?> clazz, String collName, boolean returnId) {
        ...
        return getMt().find(query, clazz, collName);
    }
    ...
    public static Object findAll(Class<?> entiy, String collName) {
        return getMt().findAll(entiy, collName);
    }
     ...
     **/
    public static Object findLikeByParam(String param, String key, String collName, String sortField, Sort.Direction direction, Class clazz) {
    ...
    public static void createIndex(String collName, String indexName, Map<String, Sort.Direction> map) {
        ...
        getMt().indexOps(collName).ensureIndex(index);
    }
    ...
    public static Object getIndexInfo(String collName) {
        return getMt().indexOps(collName).getIndexInfo();
    }
    ...
    public static void removeIndexByName(String collName, String indexName) {
        getMt().indexOps(collName).dropIndex(indexName);
    }
    ...
    public static void removeIndexByName(String collName) {
        getMt().indexOps(collName).dropAllIndexes();
    }
    ...
    public static List<? extends Object> findSortByParam(Class<?> obj, String collName, Map<String, Object> map, String sortField, Sort.Direction direction) {
        ...
        return getMt().find(query, obj, collName);
    }
    ...
    public static long count(String collName, String key, String value) {
        ...
        return getMt().count(query, collName);
    }
    ...
    public static Long countRangeCondition(Class<?> clazz, String collName, Criteria rangeCriteria, Map<String, Object> map) {
        ...
        return getMt().count(query, clazz, collName);
    }
    ...
    public static Object findSortFirst(Class<?> clazz, Map<String, Object> map, String collName, String field, Sort.Direction direction) {
        ...
        return getMt().findOne(query, clazz, collName);
    }
    ...
    public static void updateMulti(String accordingKey, Object accordingValue, Map<String, Object> map,
        ...
        if (type == 1) {
            getMt().updateFirst(query, update, collName);
        } else {
            getMt().updateMulti(query, update, collName);
        }
    }
    ...
    public static Object findSum(Class<?> clazz, Map<String, Object> map, String collName, String sumField, Criteria rangeCriteria) {
        ...
        return getMt().aggregate(Aggregation.newAggregation(match, count), collName, clazz).getMappedResults();
    }
...
//     * @return
//     */
    /*public static PageBean findSortPageCondition(Class<?> clazz, String collName, Map<String, Object> map,
                                                 int currentPage, int pageSize, Sort.Direction direction, String sortField) {
        ...
        if (criteria == null) {
            totalNum = getMt().count(new Query(), clazz, collName);
        } else {
            totalNum = getMt().count(new Query(criteria), clazz, collName);
        }
        int pages = (int) Math.ceil((double) totalNum / (double) pageSize);
        ...
        List<?> list = getMt().find(query, clazz, collName);
        PageBean pageModel = new PageBean();
        pageModel.setCurrentPage(currentPage);
        pageModel.setPageSize(pageSize);
        pageModel.setTotalNum((int)totalNum);
        pageModel.setTotalPage(pages);
